...
class BeatmapAttributesBuilder {
    ...
    /**
     * @param {boolean | null} [ar_with_mods]
     */
    ...
    /**
     * @param {boolean | null} [cs_with_mods]
     */
    ...
    /**
     * @param {boolean | null} [hp_with_mods]
     */
    ...
    /**
     * @param {boolean | null} [od_with_mods]
     */
...
class Performance {
     ...
     */
    set ar(ar) {
        wasm.beatmapattributesbuilder_set_hp(this.__wbg_ptr, isLikeNone(ar) ? 0x100000001 : Math.fround(ar));
    }
    /**
     * @param {boolean | null} [ar_with_mods]
     */
     ...
     */
    set cs(cs) {
        wasm.beatmapattributesbuilder_set_od(this.__wbg_ptr, isLikeNone(cs) ? 0x100000001 : Math.fround(cs));
    }
    /**
     * @param {boolean | null} [cs_with_mods]
     */
    ...
    set hitresultPriority(hitresult_priority) {
        wasm.performance_set_hitresult_priority(this.__wbg_ptr, isLikeNone(hitresult_priority) ? 3 : hitresult_priority);
    }
}
...
module.exports.__wbg_getwithrefkey_be14a94edbf4799f = function(arg0, arg1) {
...
module.exports.__wbg_set_c5541e105a6140e7 = function(arg0, arg1, arg2) {
